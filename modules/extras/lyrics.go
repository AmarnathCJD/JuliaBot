...
func initFromSrc_lyrics_0_1() { modules.QueueHandlerRegistration(registerLyricsHandlers) }
func registerLyricsHandlers() {
	c := modules.Client
	c.On("cmd:lyrics", LyricsHandler)
}
// === from lyrics_genius.go ===
...
func registerQuoteGenHandlers() {
	...
	modules.Mods.AddModule("QuoteGen", `<b>QuoteGen Module</b>
...
func initFromSrc_lyrics_genius_1_1() {
	modules.QueueHandlerRegistration(registerQuoteGenHandlers)
}

func init() {
	initFromSrc_lyrics_0_1()
	initFromSrc_lyrics_genius_1_1()
}
