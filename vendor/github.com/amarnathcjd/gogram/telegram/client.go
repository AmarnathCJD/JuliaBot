...
func (c *Client) AddNewExportedSenderToMap(dcID int, sender *mtproto.MTProto) {
...
func (c *Client) GetCachedExportedSenders(dcID int) []*mtproto.MTProto {
	c.exportedSenders.RLock()
	defer c.exportedSenders.RUnlock()

	var senders []*mtproto.MTProto
