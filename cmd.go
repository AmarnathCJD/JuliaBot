...
func initFunc(c *telegram.Client) {
	...
	if LoadModules {
		...
		c.On("cmd:rproxy", modules.RestartProxy, telegram.CustomFilter(FilterOwnerAndAuth))
		...
		c.On("cmd:del", modules.DeleteMessageHandle)
		c.On("cmd:dban", modules.DBanUserHandle)
		c.On("cmd:dmute", modules.DMuteUserHandle)
		c.On("cmd:dkick", modules.DKickUserHandle)
		c.On("cmd:pin", modules.PinMessageHandle)
		c.On("cmd:unpin", modules.UnpinMessageHandle)
		c.On("cmd:purge", modules.PurgeMessagesHandle)
		c.On("cmd:lock", modules.LockHandle)
		c.On("cmd:unlock", modules.UnlockHandle)
		c.On("cmd:locks", modules.LocksHandle)

		c.On("cmd:restart", modules.RestartHandle, telegram.CustomFilter(FilterOwner))
		...
		c.On("cmd:sh", modules.ShellHandle, telegram.CustomFilter(FilterOwner))
		c.On("cmd:bash", modules.ShellHandle, telegram.CustomFilter(FilterOwner))
		c.On("cmd:ls", modules.LsHandler, telegram.CustomFilter(FilterOwner))
		c.On("cmd:ul", modules.UploadHandle, telegram.CustomFilter(FilterOwnerNoReply))
		c.On("cmd:upd", modules.UpdateSourceCodeHandle, telegram.CustomFilter(FilterOwnerNoReply))
		c.On("cmd:gban", modules.Gban, telegram.CustomFilter(FilterOwner))
		c.On("cmd:ungban", modules.Ungban, telegram.CustomFilter(FilterOwner))
		...
		c.On("cmd:i", modules.SongHandler)
		c.On("cmd:fileinfo", modules.FileInfoHandle)
		c.On("cmd:eval", modules.EvalHandle, telegram.CustomFilter(FilterOwnerNoReply))
		c.On("cmd:go", modules.GoHandler)
		c.On("cmd:cancel", modules.CancelDownloadHandle, telegram.CustomFilter(FilterOwnerNoReply))
		c.On("cmd:post", modules.HandlePostCommand, telegram.CustomFilter(FilterOwner))

		c.On("cmd:adddl", modules.AddDLHandler, telegram.CustomFilter(FilterOwnerAndAuth))
		c.On("cmd:listdls", modules.ListDLsHandler, telegram.CustomFilter(FilterOwnerAndAuth))
		c.On("cmd:rmdl", modules.RmDLHandler, telegram.CustomFilter(FilterOwnerAndAuth))
		c.On("cmd:listdl", modules.ListDLHandler, telegram.CustomFilter(FilterOwnerAndAuth))
		...
		c.On("cmd:ldl", modules.DownloadHandle, telegram.CustomFilter(FilterOwnerNoReply))
		...
		c.On("cmd:setpfp", modules.SetBotPfpHandler, telegram.CustomFilter(FilterOwner))
